import type { UploadRawFile, UploadFile } from './upload';
declare const _default: import("vue").DefineComponent<{
    ...
    readonly onExceed: import("element-plus/es/utils").BuildPropReturn<import("element-plus/es/utils").PropWrapper<(files: File[], uploadFiles: import("./upload").UploadFiles) => void>, () => void, unknown, unknown, unknown>;
    ...
    readonly fileList: import("element-plus/es/utils").BuildPropReturn<import("element-plus/es/utils").PropWrapper<import("./upload").UploadFiles>, () => [], unknown, unknown, unknown>;
    ...
    accept: string;
    fileList: import("./upload").UploadFiles;
    ...
    onExceed: (files: File[], uploadFiles: import("./upload").UploadFiles) => void;
